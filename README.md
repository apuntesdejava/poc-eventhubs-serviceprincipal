# poc-eventhubs-serviceprincipal
...
You can then execute your native executable with: `./target/poc-eventhubs-serviceprincipal-1.0-SNAPSHOT-runner`
...
## Terraform
🟢 Outputs para application.properties
Después de terraform apply, ejecuta:

```bash
# Ver todos los valores (excepto secret):
terraform output
